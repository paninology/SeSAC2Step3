...
//  SeSAC2Step3
//
//  Created by yongseok lee on 2022/09/26.
//
...
class ViewController: UIViewController {
    ...
    //1. 인앱 상품 ID 정의
    var productIdentifiers: Set<String> = ["com.ohlee.step3.remove"]
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        requestProductData()
//        SKProductsRequestDelegate = self
    ...
    func productsRequest(_ request: SKProductsRequest, didReceive response: SKProductsResponse) {
        func productsRequest(_ request: SKProductsRequest, didReceive response: SKProductsResponse) {
                ...
                if products.count > 0 {
                    ...
                    print("No Product Found") //계약 업데이트전. 유료계약 X, Capabilities x
                }
            }
    }
